...
import static de.embl.cba.crosshair.utils.GeometryUtils.compose;
import static de.embl.cba.crosshair.utils.GeometryUtils.rotationPlaneToPlane;
...
class MicrotomeSetup {
    ...
    private void calculateTargetOffsetTilt() {
        ...
        microtome.setInitialTargetOffset( rotationPlaneToPlane(vertical, targetNormal, blockNormal) );
        ...
        microtome.setInitialTargetTilt( rotationPlaneToPlane(axisRotation, targetNormal, intersectionNormal) );
