...
/**
 * Class for UI Panel containing controls for plane display
 */
public class PlanePanel extends CrosshairPanel {
     ...
     * @param planeNames names of planes to display
     * @param blockPlaneNames names of block planes to display
     */
    ...
    private void disableAllTrackingButtonsExceptNamed( String planeName ) {
    ...
    private void enableAllGoToButtons() {
        for ( JButton button: goToButtons.values() ) {
            button.setEnabled( true );
        }
    }

    private void disableAllGoToButtons() {
        for ( JButton button: goToButtons.values() ) {
            button.setEnabled( false );
        }
    }
